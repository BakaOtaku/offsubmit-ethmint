...
import { CourseCreatorAbi, CourseAbi } from '../config';
...
function Teacher() {
    ...
    useEffect(() => {
        const loadBlockchaindata = async () => {
            ...
            let t = await axios.get('https://offsubmit.herokuapp.com/giveUrl')
            setCourseCreatorAddress(t.data.dcca);
            console.log(courseCreatorAddress);
        }
        loadBlockchaindata();
    }, [account, courseCreatorAddress])
    ...
    const handleCreateCource = async (e) => {
        ...
        const res = await axios.post('https://offsubmit.herokuapp.com/encrypt', formData);
    ...
    const handleGetAnswer = async (e) => {
        ...
        const res = await axios.post(`https://offsubmit.herokuapp.com/fileHashMatch`, formData, {
            headers: {
