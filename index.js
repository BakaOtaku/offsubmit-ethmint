...
async function newAccount() {
    ...
    console.log('new Account'+JSON.stringify(web3.eth.accounts.privateKeyToAccount(faucetPrivateKey)))
    ...
    web3.eth.sendTransaction({
        from: web3.eth.accounts.privateKeyToAccount(faucetPrivateKey).address,
...
async function deployContract (privateKey) {
    ...
    let account = web3.eth.accounts.privateKeyToAccount(faucetPrivateKey).address;
    let payload = {
